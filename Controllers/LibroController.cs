    ...
    public class LibroController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var libro = await _context.Libros
                .Include(l => l.Autor).Include (l => l.Categoria)
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,AutorId, CategoriaId,Prestado")] Libro libro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,AutorId, CategoriaId")] Libro libro)
        {
            if (id != libro.Id)
            {
                return NotFound();
